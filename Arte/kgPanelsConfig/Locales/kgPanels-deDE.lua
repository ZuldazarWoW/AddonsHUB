...
L["Anchor From"] = "eigener Ankerpunkt" -- Needs review
L["Anchor To"] = "fremder Ankerpunkt" -- Needs review
L["Anchoring from."] = "eigener Ankerpunkt" -- Needs review
L["Anchoring to."] = "Ankerpunkt des Anker Frames" -- Needs review
...
Wähle die Farbe in der Hauptsektion des jeweiligen Panels.]=] -- Needs review
L["FAQ_2_4"] = [=[
...
L["Textures"] = "Texturen"
L["There is already a panel with that name. Overwrite?"] = "Es gibt bereits einen Panel mit diesem Namen. Überschreiben?"
...
L["Tile Background"] = "Titel Hintergrund"
